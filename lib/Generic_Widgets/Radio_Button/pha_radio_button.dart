...
class PHARadioButton extends StatefulWidget {
  ...
  const PHARadioButton({super.key, required this.items, required this.selectedValue, required this.onSelected});

  @override
  _PHARadioButtonState createState() =>
      _PHARadioButtonState();
}

class _PHARadioButtonState extends State<PHARadioButton> {
