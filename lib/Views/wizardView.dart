          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                PHAText(
                  text: 'یہ وزرڈ جائیداد کی دیکھ بھال کے چارجز کا حساب لگانے اور ادا کرنے کے عمل میں آپ کی رہنمائی کرے گا۔ آپ انٹرنیٹ بینکنگ، اے ٹی ایم، آئی بی ایف ٹی یا 1 لنک/ 1 بل ممبر بینکوں کے ذریعے مینٹیننس چارجز ادا کر سکتے ہیں۔',
                  fontSize: 14.sp,
                  fontWeight: FontWeight.w500,
                  textAlign: TextAlign.center,
                ),
